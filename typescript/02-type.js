/*
원시형 타입 : number, strig, boolean, symbol, null, undefined
...
//null : 값이 없음을 의미
var text1; //null로만 타입을 지정하면 타입검사를 진행할때 명확한 타입을 알 수 없기에 사용을 지향하도록 한다.
var text2; //값을 비워야 할때는 or연산자를 이용해서 이방법을 권장한다.
text1 = null;
text2 = "kim";
//undefiend
var age;
